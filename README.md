...
- Если ввести подсказку в поле подсказок, Qwen перестаёт различать имена и я не знаю как это исправить, однако транскрипция распознаёт проблемные места лучше с подсказками.
